-- @example nil -> focal - Logistic Growth archetype.
...
do
    ...
    cellSample.stock = 0
    print ("[",cellSample.x,",", cellSample.y,"] = ", cellSample.stock, "; [",cellSample2.x,",", cellSample2.y,"] =", cellSample2.stock)
end
...
--    Event {
--        action = function(event)
--            mapCs:save("SAVES/logisticNeightTrue/WrapLogiticoMapCs" .. event:getTime() .. ".bmp")
--            mapCs2:save("SAVES/logisticNeightTrue/WrapLogiticoMapCsCentral" .. event:getTime() .. ".bmp")
--            chartSummaryAg:save("SAVES/logisticNeightTrue/WrapLogiticoChartSummaryAg" .. event:getTime() .. ".bmp")
...
--    forEachNeighbor
--         neighbor= taxa × neigh.past × (1 - neigh.past/CCcell)
--    end
--end
CCcell = carryCapacity / #cs
--verticalDispersion_rule = function(t, stock)
--    return rate * stock * (1 - stock / CCcell)
--end
verticalDispersion_rule = function(t, sourceCell, targetCell, neighborSourceCell, neighborTargetCell)
    return rate * neighborTargetCell.stock * (1 - neighborTargetCell.stock / CCcell)
end
----------------------------------------------------------------------
-- ConnectorS
