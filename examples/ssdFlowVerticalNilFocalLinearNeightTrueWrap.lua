-- @example nil -> focal - Linear Growth archetype.
...
mapCs2 = Map {
    title = "Initial Stock levels (0.001) and 5x5 positon = 100",
    target = cs2,
    select = "logstock",
    min = 0,
    max = 8, --15000, --4000000,
...
timer = Timer {
    ...
    Event {
        ...
        action = function(event)
            ...
            print('linearGrouwth:', summaryAg.linearGrouwth)
...
--    Event {
--        action = function(event)
--            mapCs:save("SAVES/linearNeightTrueWrap/WrapLinearMapCs" .. event:getTime() .. ".bmp")
--            mapCs2:save("SAVES/linearNeightTrueWrap/WrapLienarMapCsCentral" .. event:getTime() .. ".bmp")
--            chartSummaryAg:save("SAVES/linearNeightTrueWrap/WrapLienarChartSummaryAg" .. event:getTime() .. ".bmp")
...
--erticalDispersion_rule = function(t, stock) return rate end
verticalDispersion_rule = function(t, sourceCell, targetCell, neighborSourceCell, neighborTargetCell) return rate end
----------------------------------------------------------------------
-- ConnectorS
