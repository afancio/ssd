...
-- @image ssdLocalLocalFeedbackLoop3Stock.png
...
--verticalDispersion_rule = function(t, stock, stock2, stock3, stock4) return verticalDispersion_rate * stock * stock2 * stock3 * stock4 end
verticalDispersion_rule = function(t, sourceCell, targetCell, neighborSourceCell, neighborTargetCell)
    return verticalDispersion_rate * sourceCell.stock * sourceCell.stock2 * targetCell.stock * targetCell.stock2
end
---------------------------------------------------------------
-- Flow OPERATORS
focal_Flow = Flow {
